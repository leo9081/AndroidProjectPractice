...
public class ExampleHandlerThread extends HandlerThread {
    ...
    private static final int EXAMPLE_TASK = 1;

    private Handler handler;

    public ExampleHandlerThread() {
        super("ExampleHandlerThread", Process.THREAD_PRIORITY_DEFAULT);
    ...
    protected void onLooperPrepared(){
        ...
        handler = new Handler(){
            ...
            public void handleMessage(Message msg) {
                switch (msg.what){
                    case EXAMPLE_TASK:
                        Log.d(TAG, "Example Task: arg1: " + msg.arg1 + " what: " + msg.what + " obj: " + msg.obj);
                        for (int i = 0; i < 4; i++) {
